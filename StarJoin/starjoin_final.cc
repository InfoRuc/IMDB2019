...
#define SUPPLIER_COLUMN 1
#define PART_COLUMN 2
#define CUSTOMER_COLUMN 3
...
typedef struct s_gVector s_gVector;
struct s_gVector{  //define compressed group vector with OID and non-zero group index
    int oid;
    int group_idx;
};
...
{
  // selectivity, num_groups, num_tuples, bitmapflag
  {1, 5, num_date, 1},  
  {1, 5, num_supplier, 1},
  {1, 5, num_part, 1},
  {1, 5, num_customer, 1},
